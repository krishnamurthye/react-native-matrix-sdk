...
interface NativeModuleInterface {
  ...
  ubrn_uniffi_matrix_sdk_ffi_fn_method_client_add_call_event_listener(
    ptr: bigint,
    listener: bigint
  ): bigint;
  ...
  ubrn_uniffi_matrix_sdk_ffi_fn_init_callback_vtable_calleventlistener(
    vtable: UniffiVTableCallbackInterfaceCallEventListener
  ): void;
  ...
  ubrn_uniffi_matrix_sdk_ffi_checksum_method_client_add_call_event_listener(): number;
  ...
  ubrn_uniffi_matrix_sdk_ffi_checksum_method_calleventlistener_on_invite(): number;
  ubrn_uniffi_matrix_sdk_ffi_checksum_method_calleventlistener_on_answer(): number;
  ubrn_uniffi_matrix_sdk_ffi_checksum_method_calleventlistener_on_candidates(): number;
  ubrn_uniffi_matrix_sdk_ffi_checksum_method_calleventlistener_on_hangup(): number;
  ubrn_uniffi_matrix_sdk_ffi_checksum_method_calleventlistener_on_negotiate(): number;
  ubrn_uniffi_matrix_sdk_ffi_checksum_method_calleventlistener_on_select_answer(): number;
  ubrn_uniffi_matrix_sdk_ffi_checksum_method_calleventlistener_on_reject(): number;
...
type UniffiCallbackInterfaceCallEventListenerMethod0 = (
  uniffiHandle: bigint,
  roomId: Uint8Array,
  callId: Uint8Array,
  sender: Uint8Array,
...
type UniffiCallbackInterfaceCallEventListenerMethod1 = (
  uniffiHandle: bigint,
  roomId: Uint8Array,
  callId: Uint8Array,
  sender: Uint8Array,
...
type UniffiCallbackInterfaceCallEventListenerMethod2 = (
  uniffiHandle: bigint,
  roomId: Uint8Array,
  callId: Uint8Array,
  sender: Uint8Array,
...
type UniffiCallbackInterfaceCallEventListenerMethod3 = (
  uniffiHandle: bigint,
  roomId: Uint8Array,
  callId: Uint8Array,
  sender: Uint8Array,
...
type UniffiCallbackInterfaceCallEventListenerMethod4 = (
  uniffiHandle: bigint,
  roomId: Uint8Array,
  callId: Uint8Array,
  sender: Uint8Array,
...
type UniffiCallbackInterfaceCallEventListenerMethod5 = (
  uniffiHandle: bigint,
  roomId: Uint8Array,
  callId: Uint8Array,
  sender: Uint8Array,
  selectedPartyId: Uint8Array
) => UniffiResult<void>;
type UniffiCallbackInterfaceCallEventListenerMethod6 = (
  uniffiHandle: bigint,
  roomId: Uint8Array,
  callId: Uint8Array,
  sender: Uint8Array,
...
export type UniffiVTableCallbackInterfaceCallEventListener = {
  onInvite: UniffiCallbackInterfaceCallEventListenerMethod0;
  onAnswer: UniffiCallbackInterfaceCallEventListenerMethod1;
  onCandidates: UniffiCallbackInterfaceCallEventListenerMethod2;
  onHangup: UniffiCallbackInterfaceCallEventListenerMethod3;
  onNegotiate: UniffiCallbackInterfaceCallEventListenerMethod4;
  onSelectAnswer: UniffiCallbackInterfaceCallEventListenerMethod5;
  onReject: UniffiCallbackInterfaceCallEventListenerMethod6;
  uniffiFree: UniffiCallbackInterfaceFree;
};
